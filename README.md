...
| **Данные и очереди** | PostgreSQL, MongoDB, Redis, Kafka, RabbitMQ, BullMQ |
| **Cloud и DevOps** | Docker, Kubernetes, GitLab CI/CD, AWS, GCP, Nginx |
| **AI и LLM** | мультиагентные системы, RAG, pgvector, Qdrant, embeddings, MCP, OpenRouter, OWASP LLM Top 10 |
